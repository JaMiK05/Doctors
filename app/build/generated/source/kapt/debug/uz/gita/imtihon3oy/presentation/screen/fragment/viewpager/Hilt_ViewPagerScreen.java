...
public abstract class Hilt_ViewPagerScreen extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ViewPagerScreen() {
    super();
  }

  Hilt_ViewPagerScreen(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewPagerScreen_GeneratedInjector) this.generatedComponent()).injectViewPagerScreen(UnsafeCasts.<ViewPagerScreen>unsafeCast(this));
    }
  }
