...
public abstract class Hilt_RegistrFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RegistrFragment() {
    super();
  }

  Hilt_RegistrFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RegistrFragment_GeneratedInjector) this.generatedComponent()).injectRegistrFragment(UnsafeCasts.<RegistrFragment>unsafeCast(this));
    }
  }
